...
Jeweler::Tasks.new do |gem|
  ...
  gem.name = "bio-polygenetics"
  gem.homepage = "http://github.com/homonecloco/bioruby-polygenetics"
  gem.license = "MIT"
  gem.summary = %Q{TODO: one-line summary of your gem}
  gem.description = %Q{TODO: longer description of your gem}
  gem.email = "ricardo.ramirez-gonzalez@tgac.ac.uk"
  gem.authors = ["Ricardo H. Ramírez-Gonzalez"]
...
Rake::RDocTask.new do |rdoc|
  ...
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title = "bio-polygenetics #{version}"
