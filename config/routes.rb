Rails.application.routes.draw do
 ...
 #DEPRECATED 
 mount_at = BioPolygenetics::Engine.engine_name== "bio_polygenetics_engine" ? "" : BioPolygenetics::Engine.engine_name
...
## mount BioPolygenetics::Engine=>"your_mount_point", :as=>'your_personal_engine_name' # but is better to redefine the mount point in the Rails application.
